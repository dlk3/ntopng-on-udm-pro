...
mkdir -p 644 %{buildroot}/var/lib/ntopng
...
%changelog
* Sat Jan 13 2024 David King <dave@daveking.com>
    Update version number to 6.1.x (unstable)
    Add /var/lib/ntopng
...
* Sun Mar 07 2021 David King <dave@daveking.com>
	Add @BIN_DIR@ patch
