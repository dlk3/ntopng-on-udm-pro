...
our_dns_servers = ['192.168.1.21', '192.168.1.40']
    ...
    if alert_json['alert_id'] == 33:
        ...
        try:
            ...
            with open(missed_alerts_filename, 'a') as f:
                f.write('{}\n'.format(alert))
            return
        # If one of our DNS servers wasn't the client, do nothing
        if alert_json['cli_id'] not in our_dns_servers.append(wan_ip):
            return
